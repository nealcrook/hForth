...
\ 'heapsize' is adjusted to 8 k CELLS from original 16 k CELLS for 8086 hForth.
\ Implementation words are hidden in MEMORY-ALLOC-WORDLIST.
\ Feb. 20, 1996
\ Wonyong Koh
...
WORDLIST WORDLIST-NAME MEMORY-ALLOC-WORDLIST
MEMORY-ALLOC-WORDLIST SET-CURRENT
GET-ORDER MEMORY-ALLOC-WORDLIST SWAP 1+ SET-ORDER
