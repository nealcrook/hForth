...
\ TODO-GFORTH -- doesn't see ( as a comment in this context -- looks like a string parsing problem. I worked around this by running expand on the whole file. Ought to be able to solve the problem by parsing with SWORD
